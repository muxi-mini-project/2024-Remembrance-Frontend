    ...
    <>
      <View className='input-back'>
        <View className='input-top'>
          <Input type='text' value={newmailbox} placeholder='请输入邮箱' className='input' onInput={handleInput1} onBlur={handleInputText}></Input>
          <Input type='password' value={newpassword} placeholder='输入密码' className='input' onInput={handleInput2} onBlur={handleInputPassword}></Input>
        </View>
